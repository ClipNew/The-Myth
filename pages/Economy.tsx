...
const Economy = () => {
  ...
  return (
    <div className="py-24 px-6 max-w-7xl mx-auto space-y-32">
      ...
      <section className="relative glass-card rounded-[4rem] p-12 md:p-24 border border-indigo-500/20 overflow-hidden shadow-2xl shadow-indigo-500/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            <h2 className="text-5xl md:text-7xl font-cinzel font-black text-white uppercase tracking-tighter leading-none">BLACK MARKET <br/><span className="text-indigo-500">DOMINATION</span></h2>
            <p className="text-slate-400 text-xl font-light leading-relaxed italic border-l-4 border-indigo-500 pl-8">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-6 group">
                  <div className="w-12 h-12 bg-indigo-600/10 rounded-2xl border border-indigo-500/20 flex items-center justify-center shrink-0 group-hover:bg-indigo-600 group-hover:text-white transition-all">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex items-center justify-center gap-10">
               <div className="text-center">
                 <div className="text-3xl font-black text-white tracking-tighter">50M+</div>
                 <div className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest">PROFIT / RUN</div>
               </div>
               <div className="w-[1px] h-10 bg-white/10"></div>
               <div className="text-center">
                 <div className="text-3xl font-black text-white tracking-tighter">ZERO</div>
                 <div className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest">LOSS RECORD</div>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-16">
        <div className="text-center">
          ...
          <p className="text-slate-500 text-xl font-light">"More ways to fill your war chest than any other guild."</p>
        </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="glass-card p-16 rounded-[3.5rem] border border-white/10 relative overflow-hidden flex flex-col justify-between shadow-2xl">
          <div>
            <h2 className="text-4xl font-cinzel font-black text-white mb-10 flex items-center uppercase tracking-tighter text-glow">
              <PieChart className="w-10 h-10 text-indigo-500 mr-5" /> LOOT DISTRIBUTION
            </h2>
            <p className="text-slate-400 mb-10 text-xl leading-relaxed font-light italic">
              "We run on 100% transparency. Every silver gained in a guild operation is tracked and shared."
            </p>
            <div className="space-y-8">
              <div className="flex justify-between items-center p-6 bg-white/5 rounded-2xl border border-white/5 group hover:border-indigo-500/20 transition-all">
                <span className="text-slate-300 font-bold text-xl uppercase tracking-widest">Active Warriors</span>
                <span className="text-emerald-400 font-black text-4xl tracking-tighter">80%</span>
              </div>
              <div className="flex justify-between items-center p-6 bg-white/5 rounded-2xl border border-indigo-500/20 group hover:scale-[1.02] transition-transform">
                <span className="text-slate-300 font-bold text-xl uppercase tracking-widest">Regear Reserves</span>
                <span className="text-indigo-400 font-black text-4xl tracking-tighter">15%</span>
              </div>
              <div className="flex justify-between items-center p-6 bg-white/5 rounded-2xl border border-white/5 group hover:border-indigo-500/20 transition-all">
                <span className="text-slate-300 font-bold text-xl uppercase tracking-widest">Logistics Lead</span>
                <span className="text-purple-400 font-black text-4xl tracking-tighter">5%</span>
              </div>
            </div>
          </div>
        </div>

        <div className="glass-card p-16 rounded-[3.5rem] border border-indigo-500/20 relative overflow-hidden bg-gradient-to-br from-indigo-500/[0.05] to-transparent shadow-2xl flex flex-col justify-center text-center">
            <ShieldCheck className="w-24 h-24 text-indigo-500 mx-auto mb-10 animate-pulse" />
            <h2 className="text-4xl font-cinzel font-black text-white mb-6 uppercase tracking-tighter">ZERO FINANCIAL RISK</h2>
            <p className="text-slate-400 text-xl leading-relaxed font-light italic mb-12">
              "In The Myth, you never pay to play. No mandatory taxes, no donation quotas. We provide the tools; you provide the skill."
            </p>
            <Link to="/recruitment" className="inline-flex items-center justify-center gap-4 py-6 px-12 bg-indigo-600 text-white rounded-full font-black text-xl uppercase tracking-tighter shadow-xl shadow-indigo-600/30 hover:scale-105 transition-all group">
               ENLIST IN THE VANGUARD <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
            </Link>
        </div>
      </section>
    </div>
